...
final readonly class Limits
{
     ...
     * @param int $maxInputBytes Maximum admitted input bytes, from 1 through 16777216 inclusive.
     *
    ...
    public function __construct(
        ...
        if ($maxInputBytes < 1 || $maxInputBytes > 16777216) {
            throw new InvalidArgumentException('Canonical input budget must be between 1 and 16777216 bytes.');
        }
    }
}
